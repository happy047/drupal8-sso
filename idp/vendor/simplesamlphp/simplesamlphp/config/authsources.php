...
$config = [
    ...
    'drupal-userpass' => array('drupalauth:External',
        ...
        'drupal_logout_url' => 'http://idp.lndo.site/user/logout',

        // the URL of the Drupal login page
        'drupal_login_url' => 'http://idp.lndo.site/user/login',
    ...
    'example-sql' => [
        'sqlauth:SQL',
        'dsn' => sprintf('mysql:host=%s;port=%s;dbname=%s', 'database', '', 'sso2'),
        'username' => 'drupal8',
        'password' => 'drupal8',
        'query' => 'SELECT name, mail FROM users_field_data WHERE name = :username ' .
            'AND pass = SHA512(:password);',
    ],
    */
